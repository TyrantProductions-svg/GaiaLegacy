...
## Phase 10 UI font and icons

The final Phase 10 bitmap font, **Quiet Rune 5x7 version 1**, was independently
authored in this repository from blank five-by-seven pixel grids and generated
by the project-local Java tool. The final source and generated atlas do not
include the provenance-ambiguous Mode 13h/Allegro-style glyph bytes that
appeared in an earlier uncommitted candidate. GaiaLegacy does not add Allegro
as a source, binary, or build dependency.

The Phase 10 icon atlas is generated by project-local Java code from the
existing GaiaLegacy block textures. No web artwork, operating-system font, or
third-party font or icon asset is included by Phase 10.
